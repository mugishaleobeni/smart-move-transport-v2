                ...
                <div className="mb-8">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    <div className="glass rounded-xl p-4 text-center">
                      ...
                      <div className="text-xs text-muted-foreground uppercase font-bold tracking-tighter">{t('admin.cars.labels.inCity')}</div>
                    </div>
                    <div className="glass rounded-xl p-4 text-center">
                      <div className="text-xl font-bold text-accent">RWF {car.priceProvince || '25,000'}</div>
                      <div className="text-xs text-muted-foreground uppercase font-bold tracking-tighter">{t('admin.cars.labels.province')}</div>
                    </div>
                    <div className="glass rounded-xl p-4 text-center">
